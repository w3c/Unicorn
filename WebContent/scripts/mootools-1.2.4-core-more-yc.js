// This file contains the full Mootools 1.2.4 Core + the following 1.2.4.4 More modules and their dependencies: Chain.Wait, Elements.Forms, Form.Validator, FX.Slide, FX.SmoothScroll, Tips
...
return this.get("validator",a).validate();}});var FormValidator=Form.Validator;Fx.Scroll=new Class({Extends:Fx,options:{offset:{x:0,y:0},wheelStops:true},initialize:function(b,a){this.element=this.subject=document.id(b);
